...
use frontend\modules\rbac\models\RbacAuthAssignment;
use frontend\modules\rbac\models\RbacAuthItem;
use frontend\modules\rbac\models\RbacAuthItemChild;
use frontend\modules\rbac\models\RbacAuthRule;
use Yii;
 ...
 */
class RbacAuthItemeee extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(RbacAuthItemeee::class, ['name' => 'child'])->viaTable('rbac_auth_item_child', ['parent' => 'name']);
    }
    ...
    {
        return $this->hasMany(RbacAuthItemeee::class, ['name' => 'parent'])->viaTable('rbac_auth_item_child', ['child' => 'name']);
    }
}
