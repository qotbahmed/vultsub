...
?>
    ...
    <div class="row">
<?php
if($providerInvitations->totalCount){
    ...
    echo Gridview::widget([
        ...
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('backend', 'Invitations').' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerQuestionAnswers->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('backend', 'Question Answers').' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerQuestionRequestHint->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('backend', 'Question Request Hint').' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerTransactionsLog->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('backend', 'Transactions Log').' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerWithdrawal->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('backend', 'Withdrawal').' '. $this->title),
        ],
