...
<div class="profile-form">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12"> <?php echo $form->field($model, 'full_name') ?> </div>                
            </div>
            <div class="row">
                <div class="col-6"> <?php echo $form->field($model, 'username') ?> </div>
                <div class="col-6"><?php echo $form->field($model, 'email')->input('email') ?></div>
            </div>
            <div class="row">
