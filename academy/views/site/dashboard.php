...
<body>
            ...
            <div class="col-md-3 col-lg-2 sidebar p-0 position-relative">
                <div class="p-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h4 class="text-white mb-0"><?= htmlspecialchars($academy->title) ?></h4>
                    </div>
                </div>
                <nav class="nav flex-column px-3 position-relative">
                    <a class="nav-link active" href="<?= \yii\helpers\Url::to(['/site/index']) ?>">
                        <i class="fas fa-tachometer-alt me-3"></i>لوحة التحكم
                    </a>
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/players/index']) ?>">
                        <i class="fas fa-users me-3"></i>إدارة اللاعبين
                    </a>
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/schedule/index']) ?>">
                        <i class="fas fa-calendar me-3"></i>الجدولة
                    </a>
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/teams/index']) ?>">
                        <i class="fas fa-users-cog me-3"></i>الفريق
                    </a>
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/payments/index']) ?>">
                        <i class="fas fa-credit-card me-3"></i>المدفوعات
                    </a>
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/reports/index']) ?>">
                        <i class="fas fa-chart-line me-3"></i>التقارير
                    </a>
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/skills/index']) ?>">
                    ...
                    <a class="nav-link" href="<?= \yii\helpers\Url::to(['/site/logout']) ?>" data-method="post">
                ...
                <div class="trial-banner position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0">لديك <?= $stats['trialDaysLeft'] ?> أيام متبقية في التجربة المجانية. <a href="/pricing" class="text-white text-decoration-underline fw-bold">ترقية الآن</a> للاستمرار في استخدام جميع المميزات.</p>
                        </div>
                        ...
                        <div class="stat-card">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 text-primary"><?= $stats['totalPlayers'] ?></h3>
                        ...
                        <div class="stat-card">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 text-success"><?= $stats['totalActivities'] ?></h3>
                        ...
                        <div class="stat-card">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 text-warning"><?= number_format($stats['totalRevenue']) ?></h3>
    ...
    <script src="https://cdn.jsdelivr.net/npm/yii2@2.0.0/assets/yii.js"></script>
</body>
</html>
