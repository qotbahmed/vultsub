...
return [
    ...
    'Points per second' => 'النقاط في الثانية',
    'Reading points delay' => 'تأخير نقاط القراءة',
    'Maximum points collected daily for each person' => 'الحد الأقصى للنقاط اليومية لكل شخص',
    'Points for the day' => 'نقاط اليوم',
    'Sponsor' => 'الراعي',
    'Choose Sponsors' => 'اختر الراعي',
    'Create Sponsor Log' => 'اضافة تبرع',
    'Sponsor Log' => 'تبرع',
    'Sponsor Logs' => 'التبرعات',
    'Sponsor Log was successfuly created' => "تم إنشاء التبرع بنجاح",
    'Total Sponsors' => 'اجمالي عدد الرعاة',
    'Total Sponsors Logs' => 'اجمالي تبرعات الرعاة',
    'Sponsor Amount' => 'مبلغ التبرع',
    'Sponsor Name' => 'المتبرع',
    'Comparison with last month' => 'مقارنة باخر شهر',
    'Total Donations' => 'إجمالي تبرعات الرعاة',
    'Comparison with Last Month' => 'مقارنة بالشهر الماضي',
    'Currency' => 'دولار',
    'Donation time and date' => 'وقت وتاريخ التبرع',
    'Donation ID' => 'رقم العملية',
    'Total donations in the system' => 'اجمالي التبرعات في النظام',
    'Total donations' => 'اجمالي التبرعات ',
    'New donation' => 'احدث تبرع ',



    'Welcome Back, ' => 'مرحباً بك يا ',
    'Latest Statistics' => 'أحدث الإحصائيات',
    'Donations Requests' => 'تبرعات الطلبات',
    'Total Donations Over the Year' => 'إجمالي التبرعات على مدار العام',
    'Latest Donations' => 'أحدث التبرعات',
