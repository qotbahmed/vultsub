 ...
 *
 * @property int $id
 * @property int $player_answer_behavior_id
 ...
 *
 * @property PlayerAnswerBehavior $playerAnswerBehavior
 */
class BehaviorLog extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['player_answer_behavior_id', 'start_date', 'end_date'], 'required'],
            [['player_answer_behavior_id', 'notification_preference', 'assignment_status', 'updated_by', 'created_by'], 'integer'],
            [['start_date', 'end_date', 'created_at', 'updated_at'], 'safe'],
            [['player_answer_behavior_id'], 'exist', 'skipOnError' => true, 'targetClass' => PlayerAnswerBehavior::class, 'targetAttribute' => ['player_answer_behavior_id' => 'id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('common', 'ID'),
            'player_answer_behavior_id' => Yii::t('common', 'Player Answer Behavior ID'),
    ...
    /**
     * Gets query for [[PlayerAnswerBehavior]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getPlayerAnswerBehavior()
    {
        return $this->hasOne(PlayerAnswerBehavior::class, ['id' => 'player_answer_behavior_id']);
    }
