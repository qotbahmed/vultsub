...
/**
 * This is the model class for table "contact_us_vult".
 *
 * @property int $id
 ...
 */
class ContactUsVult extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['description'], 'string'],
            [['created_at', 'name', 'contact_email'], 'string', 'max' => 255],
