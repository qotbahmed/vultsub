...
xmlns:v="urn:schemas-microsoft-com:vml" dir="rtl" lang="ar">
  ...
  <tbody>
    <tr style="vertical-align: top" valign="top">
      <td style="word-break: break-word; vertical-align: top" valign="top">
        ...
        <div style="background-color: #30a1cb">
          <div class="block-grid" style="
            ...
            <div style="
                  ...
                  background-color: #30a1cb;
                ">
              <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#30a1cb;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:640px"><tr class="layout-full-width" style="background-color:#30a1cb"><![endif]-->
              <!--[if (mso)|(IE)]><td align="center" width="640" style="background-color:#30a1cb;width:640px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:0px; padding-bottom:0px;"><![endif]-->
                  ...
                  <div style="
                    ...
                    <div align="center" class="img-container center fixedwidth"
                      style="padding:20px 40px">
                         ...
                         <img align="center" alt="Zekr logo" border="0" class="center fixedwidth"
                              src="<?= Yii::getAlias('@apiUrl'); ?>/img/mail_logo.png" style="
              ...
              <div class="col num12" style="
                ...
                <div class="col_cont" style="width: 100% !important">
                  ...
                  <div style="
                      ...
                      ">
                    <!--<![endif]-->
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 30px; padding-left: 30px; padding-top: 45px; padding-bottom: 40px; font-family: Tahoma, sans-serif"><![endif]-->
                    <div style="
                          /* color: #555555; */
                          font-family:Cairo, Helvetica, Trebuchet MS, Lucida Grande,
                      ...
                      <div class="txtTinyMce-wrapper" style="
                        ...
                        <p style="
                            ...
                            <b style="color: #000000;">
                                    ...
                                    أهلاً <?php echo Html::encode($name) ?>
                          ...
                          <br /><br />
                          يرجي استخدام الرمز السابق  لتغيير كلمة المرور الخاصة بحسابك,
        ...
        <div style="background-color: transparent">
          <div class="block-grid" style="
            ...
            <div style="
                  ...
                  background-color: #FAFAFA;
                ">
              <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:640px"><tr class="layout-full-width" style="background-color:#FAFAFA"><![endif]-->
              <!--[if (mso)|(IE)]><td align="center" width="640" style="background-color:#FAFAFA;width:640px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:0px; padding-bottom:0px;"><![endif]-->
              <div class="col num12" style="
                    min-width: 320px;
                    max-width: 640px;
                    display: table-cell;
                  ...
                  <div style="
                    ...
                    <!-- <div align="center" class="img-container center fixedwidth"
                      ...
                      <img align="center" alt="Alternate text" border="0" class="center fixedwidth"
                        src="https://drive.google.com/uc?export=view&id=1t2BuIUfnC6UPLkAQSUiUr0CIcPUw4qQu" style="
                            text-decoration: none;
                            -ms-interpolation-mode: bicubic;
                            height: auto;
                            border: 0;
                               ...
                               <tbody>
                                 <tr align="center" style="
                                   ...
                                   <td style="
                                        ...
                                        padding-left: 10px;
                                      " valign="top">
                                     <img     src="<?= Yii::getAlias('@apiUrl'); ?>/img/mail_logo.png" >
                                   </td>
